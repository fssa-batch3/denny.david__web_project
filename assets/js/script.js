...
let data = [
    ...
    {"image-source": "../assets/image/phone_watch.jpg",
     ...
     "audio_source": "../assets/audio/Y2Mate.is - 84 BPM - 24 - Metronome-ZEfXMbfRsNA-128k-1654630603724.mp3",
     "title": "1.What is the timing?",
     "options":"a). b). c). d).",
     "choices":"6/8 1/2 4/4 3/4"
    },
    {
      "audio_source": "../assets/audio/Y2Mate.is - 70 BPM 34 Wood Metronome HD-yiUqTnfW3hY-160k-1654631078769.mp3",
    ...
    {
      "audio_source":"../assets/audio/Y2Mate.is - 70 BPM 44 Wood Metronome HD-zLnmY6hNINM-160k-1656908577444.mp3",
      "choices":"3/4 1/2 3/4 4/4",
